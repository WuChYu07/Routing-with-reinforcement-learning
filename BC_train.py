...
if __name__ == "__main__":
    ...
    #PPO_model.load_state_dict(torch.load('IL_agent_a.pt'))
    ...
    start_pos, end_pos = [(5, 16), (9, 16), (16, 14), (15, 17), (14, 12)], [(19, 0), (11, 10), (9, 3), (18, 19), (16, 12)]
    ...
    for i in range(num_episodes):
        ...
        episode_return, executing_id, num_step, dif = 0, 0, 0, 0  # 總reward, 正在執行動作的agent ID
        # 儲存每個episode的數據
        transition_dict = {
            'observations': [],
            'distances': [],
        ...
        print('Episode', i, 'dif:', dif, 'loss:', end='')
        centralized_agent.imitate(transition_dict)
        if i % 100 == 0:
            torch.save(PPO_model.state_dict(), 'IL_agent_a.pt')
